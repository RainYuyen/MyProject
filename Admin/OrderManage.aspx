            ...
            <div class="card-body wizard-content">
                <table id="sort-table" class="table table-bordered display">
                    ...
                    <tbody>
                        <%-- <tr>
                            <td>
                                <input type="button" class="btn btn-primary"  /></td>
                        </tr>--%>
                    </tbody>
                </table>
            </div>
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    $.each(customers, function () {
                        ...
                        //var time = $(this).find("Create_time").text().split('.')[0].replace('T', ' ').replace('-', '/').replace('-', '/');
                        ...
                        rows += `<tr><td id="tdname">${id}</td><td>${time}</td><td>${username}</td><td>${prodid}__${prodname}</td><td style="text-align:center;">${count}</td><td style="text-align:center;">${status}</td><td><input type="button" class="btn btn-primary" style="" onclick="status(${id})" value="出貨" /></td><td>${realname}</td><td>${address}</td><td>${phone}</td></tr>`
                    });
